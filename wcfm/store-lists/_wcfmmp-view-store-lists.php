...
$wcfm_vendors_ids_args = array(

    'role'    => 'wcfm_vendor',
    'fields' => 'ID',
//    'meta_key'     => 'vendor_accreditation',
//	'meta_value'   =>  'on',
//	'meta_compare' => '=',
);

$wcfm_vendors = get_users( $wcfm_vendors_ids_args );

$includes = $wcfm_vendors;

$stores_new_data = array();

foreach($wcfm_vendors as $vendor_id) {

    $stores_new_data += array($vendor_id => '');
}

$stores = $stores_new_data;
